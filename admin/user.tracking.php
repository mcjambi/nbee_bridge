...
function nbee_add_tracking_to_header()
{
    ...
    if ($nbee_user_tracking_status != "0") {
        wp_enqueue_script('nbee-passport', NBEE_PLUGIN_PATH . 'admin/js/passport.js', array('jquery'), NBEE_PLUGIN_VERSION);
        wp_enqueue_script('nbee-requestee', NBEE_PLUGIN_PATH . 'admin/js//requestee.js', array('nbee-passport'), NBEE_PLUGIN_VERSION);
    }
